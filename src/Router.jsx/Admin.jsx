...
import AddCompliance from "../projectmanagmentAdmin/AddCompliance";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/getEmployeStatus"
          element={<GetEmployeStatus></GetEmployeStatus>}
        />
        <Route
          path="/latestLocaction"
          element={<LatestLocaction></LatestLocaction>}
        />
        <Route path="/addCompliance" element={<AddCompliance />} />
      </Routes>
    </div>
  );
}
